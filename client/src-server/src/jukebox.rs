...
pub struct JukeboxState {
    ...
    pub host_decode_song_hash: Option<String>,
    pub host_decode_status: Option<String>,
    pub host_decode_error: Option<String>,
    pub mic_monitoring: bool,
    pub skip_intro_signal: u64,
    pub skip_intro_target: Option<String>,
    pub skip_outro_signal: u64,
    pub skip_outro_target: Option<String>,
...
impl JukeboxState {
    pub fn new(
        ...
        Self {
            ...
            host_decode_song_hash: None,
            host_decode_status: None,
            host_decode_error: None,
            mic_monitoring: false,
            skip_intro_signal: 0,
            skip_intro_target: None,
            skip_outro_signal: 0,
            skip_outro_target: None,
            pitch_hz: None,
            rms: None,
            mic_owner: None,
            controller: None,
